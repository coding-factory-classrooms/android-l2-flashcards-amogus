    ...
    public QuestionList(int level, int questionsNumbers) {
        ...
        switch (level) {
            case 0:
                ...
                /*
            case 1:
                questionsList = new ArrayList<String>(Collections.singletonList(normalQuestions));
                break;
            case 2:
                questionsList = new ArrayList<String>(Collections.singletonList(hardQuestions));
                break;
                */
